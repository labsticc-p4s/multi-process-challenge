...
\begin{itemize}
    ...
    \item \emph{Linguistic instantiation} (\textit{L.Inst.}): the requirements are satisfied by the instantiation of one or more concepts (for example for \textbf{S1}: \inst{Requirement analysis} is defined as an instance of \texttt{SETaskType}).
