...
Fig.~\ref{fig:mm}), see
Fig.~\ref{fig:BPMNSubsetExample},~\ref{fig:MultilevelArchitecture},~\ref{fig:LinguisticAndOntologicInstantiation},~\ref{fig:BaseMetamodel},~\ref{fig:AcmeFullArchitecture},
~\ref{fig:ToolingArchitecture}, while brown is used for instances of
