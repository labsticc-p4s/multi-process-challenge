...
Figure \ref{fig:AcmeFullArchitecture} shows the full architecture capturing Acme software development process, with an instance of enacted Software Engineering Process, and highlights all conceptual levels. 
