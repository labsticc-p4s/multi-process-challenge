...
In the diagram, we choose to represent the role associated with the \textit{FlexoConcept} in the class and the role type is referenced by the arrow in front of the role name.
