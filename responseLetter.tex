...
\textcolor{orange}{As indicated in the answer to the previous reviewer's comment we have refactored Section 2 in order to provide more details and make explanations easier to follow. We have done the same with }
