...
The previous figure illustrates the connection with external sources. However, in the article, we choose not to give this level of details and to keep focus on the left part of the figure. It shows how a VirtualModel (SimplifiedBPMN) can filter a model (BPMN) and be instantiated. TODO.
