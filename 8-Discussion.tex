...
%regard to cross-level relationships.
  ...
  Due to the nature of our approach and its level-blindness, \emph{deep characterization} does not apply to our solution. \todo[inline]{je suppose qu'en fait, on pourrait encoder dans un comportement quelque chose se rapprochant}
