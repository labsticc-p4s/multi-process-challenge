...
%\todo[inline]{mandatory discussion aspects ↓}
  ...
  The Openflexo approach is level-agnostic: ``levels'' have no specific
...
%regard to cross-level relationships.
  ...
  Due to the level-agnostic aspect of our approach, we could insert a new level,
...
dedicated tooling to edit a Process type, to enact a process and to execute it. Being able to provide a
solution and its associated tools quickly and easily is a noticeable feature. 
