...
\noteJC{on a du tooling, un peu moins de formalisme ; je me demande s'il ne vaut pas mieux ne pas traiter l'aspect formalisme}
...
dedicated to process edition and to process execution (\emph{e.g.} a BPMN engine). However we 
